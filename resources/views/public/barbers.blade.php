        ...
        <div class="row mt-5 d-flex justify-content-center flex-wrap">
            @foreach ($barbers as $item)
                <div class="barber-card-container">
                    <a class="card barber-card justify-content-center align-items-center rounded-circle" style="color:black; text-decoration:none;" href="{{ route('citations.getWeekByBarber', ['barber'=>'1']) }}">
