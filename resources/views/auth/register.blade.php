...
<form id="msform" method="POST" action="{{ route('register') }}">
    ...
    <!-- fieldsets -->
        ...
        <fieldset>
            ...
            <div class="input-group">
                <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" value="{{ old('phone') }}" placeholder="Número de telefono" />
                @error('phone')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <fieldset>
            ...
            <div class="input-group">
                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="name" autofocus placeholder="Nombre de la barbería">
                @error('name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="input-group">
                <input class="form-control @error('canton') is-invalid @enderror" type="text" name="canton" id="canton" value="{{ old('canton') }}" placeholder="Canton donde se localiza">
                @error('canton')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="input-group">
                <textarea name="address" class="form-control @error('address') is-invalid @enderror" placeholder="Escriba la dirección de la barbería">{{ old('address') }}</textarea>
                @error('address')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <h3 class="fs-subtitle">Antes de enviar la solicitud de registro debe tener en cuenta lo siguiente:</h3>
