        ...
        <div class="card shadow mb-5">
            ...
            <form action="" method="post">
                <div class="row align-items-center p-3">
                    <div style="max-width:300px!important; width:100%!important;" class="col-lg-4 col-sm-9">
                        {{-- Add --}}
                        ...
                        <form data-aos="fade-up" data-aos-delay="800" id="add-module-form" action="" method="POST">
                            @csrf
                            <div class="mb-3">
                              <input type="text" class="form-control" name="description" id="description" aria-describedby="help-description" placeholder="¿Cual servicio deseas agregar?">
                              <small id="help-description" class="form-text text-muted">Escriba el nombre del servicio que brindará</small>
                            </div>
                            <div class="mb-3">
                                <input type="text" class="form-control" name="price" id="price" aria-describedby="help-price" placeholder="¿Cual el precio del servicio?">
